...
export default class Step extends React.PureComponent {
  ...
  render() {
    ...
    if (step.errorMessage) {
      errorMessage = (
        <PanelWithTitle title="Message d'erreur" panelBody={true} variant="danger" className="panel-error-message">
    ...
    if (step.output) {
      logs = (
        <PanelWithTitle title="Logs" panelBody={true} variant="default" className="panel-log">
