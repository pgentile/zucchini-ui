...
public class ScenarioServiceImplTest {
    ...
    @Test
    public void tryToMergeWithExistingScenario_not_mergeOnlyNewPassedScenarii() throws Exception {
        // given
    ...
    @Test
    public void tryToMergeWithExistingScenario_with_mergeOnlyNewPassedScenarii_and_existingScenario_passed_new_faild() throws Exception {
        // given
        Scenario newScenario = Mockito.mock(Scenario.class);
        Scenario existingScenario = Mockito.mock(Scenario.class);
        PreparedQuery preparedQuery = Mockito.mock(PreparedQuery.class);
    ...
    @Test
    public void tryToMergeWithExistingScenario_with_mergeOnlyNewPassedScenarii_and_existingScenario_faild_new_passed() throws Exception {
        // given
        Scenario newScenario = Mockito.mock(Scenario.class);
        Scenario existingScenario = Mockito.mock(Scenario.class);
        PreparedQuery preparedQuery = Mockito.mock(PreparedQuery.class);
    ...
    @Test
    public void tryToMergeWithExistingScenario_with_mergeOnlyNewPassedScenarii_and_existingScenario_passed_new_passed() throws Exception {
        // given
        Scenario newScenario = Mockito.mock(Scenario.class);
        Scenario existingScenario = Mockito.mock(Scenario.class);
        PreparedQuery preparedQuery = Mockito.mock(PreparedQuery.class);
    ...
    @Test
    public void tryToMergeWithExistingScenario_with_mergeOnlyNewPassedScenarii_and_existingScenario_failed_new_failed() throws Exception {
        // given
        Scenario newScenario = Mockito.mock(Scenario.class);
        Scenario existingScenario = Mockito.mock(Scenario.class);
        PreparedQuery preparedQuery = Mockito.mock(PreparedQuery.class);
